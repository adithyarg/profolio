  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-500/30">
      ...
      <header className="px-6 lg:px-12 h-20 flex items-center justify-between border-b border-slate-200/60 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <Link className="flex items-center gap-2 font-bold text-xl tracking-tight text-slate-900 transition-colors duration-200 hover:text-indigo-600" href="/">
        ...
        <nav className="flex items-center gap-6">
          <Link className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors duration-200 min-h-[44px] flex items-center" href="/login">
            Sign in
          </Link>
          <Button asChild className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-full px-6 shadow-sm shadow-indigo-600/20 transition-all duration-200">
      ...
      <main className="flex-1">
          ...
          <div className="container px-6 mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10 z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
              <div className="space-y-6">
                <div className="inline-flex items-center rounded-full border border-indigo-600/20 bg-indigo-50 text-indigo-700 px-3 py-1 text-sm font-medium transition-all duration-200 hover:border-indigo-600/30">
                  <Sparkles className="h-4 w-4 mr-2" />
                  The new standard for resumes
                </div>
                <h1 className="text-5xl lg:text-[4rem] font-extrabold tracking-tight text-slate-900 leading-tight">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" className="h-14 px-8 text-base bg-indigo-600 hover:bg-indigo-700 text-white rounded-full shadow-lg shadow-indigo-600/20 hover:-translate-y-0.5 transition-all duration-200">
                  <Link href="/register">
                    Create Your Portfolio
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="h-14 px-8 text-base rounded-full border-slate-300 text-slate-700 hover:bg-slate-100 transition-all duration-200 hidden sm:inline-flex">
            ...
            <div className="relative z-10 hidden lg:block animate-in fade-in zoom-in-95 duration-1000 delay-150">
              <div className="relative rounded-2xl bg-white border border-slate-200 shadow-2xl p-6 rotate-1 hover:rotate-0 transition-transform duration-500">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <div className="h-3 w-3 rounded-full bg-amber-400" aria-hidden="true"></div>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <div className="h-10 w-3/4 bg-slate-200 rounded-lg" aria-hidden="true"></div>
                    <div className="h-5 w-1/2 bg-slate-100 rounded-md" aria-hidden="true"></div>
                  </div>
                  <div className="flex gap-2">
                    <div className="h-6 w-16 bg-indigo-100 rounded-full" aria-hidden="true"></div>
                    <div className="h-6 w-20 bg-indigo-100 rounded-full" aria-hidden="true"></div>
                    <div className="h-6 w-14 bg-indigo-100 rounded-full" aria-hidden="true"></div>
                  </div>
                  <div className="space-y-3">
                    <div className="h-20 w-full bg-slate-50 rounded-xl border border-slate-100" aria-hidden="true"></div>
                    <div className="h-20 w-full bg-slate-50 rounded-xl border border-slate-100" aria-hidden="true"></div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-indigo-600/5 blur-[100px] -z-10 rounded-full pointer-events-none" aria-hidden="true"></div>
            </div>
        ...
        <section className="py-24 bg-white border-t border-slate-100">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <div className="grid gap-12 md:grid-cols-3">
              <div className="space-y-5 transition-all duration-300 hover:translate-y-[-4px]">
        ...
        <section className="py-24 bg-slate-50">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">Stand out from the crowd with a portfolio that showcases your work, not just lists it.</p>
            </div>
        ...
        <section className="py-24 bg-gradient-to-br from-indigo-600 to-indigo-700 relative overflow-hidden">
          <div className="absolute inset-0 bg-grid-white/[0.05] bg-[size:20px_20px]" aria-hidden="true"></div>
          <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
            <h2 className="text-4xl font-bold tracking-tight text-white mb-6">Ready to stand out?</h2>
            <p className="text-xl text-indigo-100 mb-10 max-w-2xl mx-auto leading-relaxed">Join professionals who've ditched the PDF resume for something better. Create your portfolio in minutes.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="h-14 px-8 text-base bg-white text-indigo-600 hover:bg-slate-50 rounded-full shadow-xl hover:-translate-y-0.5 transition-all duration-200">
                <Link href="/register">
                  Get Started Free
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="h-14 px-8 text-base rounded-full border-2 border-white/20 text-white hover:bg-white/10 backdrop-blur-sm transition-all duration-200">
      ...
      <footer className="bg-slate-50 border-t border-slate-200 py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6 text-sm font-medium text-slate-500">
            <a href="#" className="hover:text-slate-900 transition-colors duration-200">Privacy</a>
            <a href="#" className="hover:text-slate-900 transition-colors duration-200">Terms</a>
          </div>
        </div>
      </footer>
    </div>
