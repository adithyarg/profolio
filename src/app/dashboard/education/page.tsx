        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 sm:p-10">
                <div className="space-y-1 mb-8">
                    <h2 className="text-xl font-bold text-slate-900">Add Education</h2>
                    <p className="text-sm font-medium text-slate-500">Include your degree, institution, and academic achievements.</p>
                </div>

                <form 
                    key={searchParams?.success ? Date.now() : 'education-form'}
                    ...
                    <div className="space-y-8">
                        <div className="grid sm:grid-cols-2 gap-8">
                            <div className="space-y-2">
                                ...
                                <Input id="degree" name="degree" required placeholder="e.g. B.Tech, M.Sc, B.E" className="h-12 rounded-xl border-slate-200 bg-slate-50/50 px-4 font-medium" />
                            </div>
                            <div className="space-y-2">
                                ...
                                <Input id="field_of_study" name="field_of_study" placeholder="e.g. Computer Science, ECE" className="h-12 rounded-xl border-slate-200 bg-slate-50/50 px-4 font-medium" />
                            </div>
                        </div>

                        <div className="space-y-2">
                            <Label htmlFor="institution" className="text-xs font-semibold uppercase tracking-wider text-slate-500">Institution *</Label>
                            <Input id="institution" name="institution" required placeholder="e.g. MIT, Stanford University" className="h-12 rounded-xl border-slate-200 bg-slate-50/50 px-4 font-medium" />
                        </div>

                        <div className="grid sm:grid-cols-2 gap-8">
                            <div className="space-y-2">
                                <Label htmlFor="grade" className="text-xs font-semibold uppercase tracking-wider text-slate-500">CGPA / Percentage</Label>
                                <Input id="grade" name="grade" placeholder="e.g. 8.5/10 or 85%" className="h-12 rounded-xl border-slate-200 bg-slate-50/50 px-4 font-medium" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="location" className="text-xs font-semibold uppercase tracking-wider text-slate-500">Location</Label>
                                <Input id="location" name="location" placeholder="e.g. Bangalore, India" className="h-12 rounded-xl border-slate-200 bg-slate-50/50 px-4 font-medium" />
                            </div>
                        </div>
